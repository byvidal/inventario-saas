...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            ...
            <flux:navlist.group :heading="__('Operaciones')" class="grid mt-4">
                <flux:navlist.item icon="shopping-cart" :href="route('movements.purchase')"
                    :current="request()->routeIs('movements.purchase')" wire:navigate>
                    {{ __('Registrar Compra') }}
                </flux:navlist.item>

                <flux:navlist.item icon="banknotes" :href="route('movements.sale')"
            ...
            <flux:navlist.group :heading="__('Administración')" class="grid mt-4">
                ...
                <flux:navlist.item icon="archive-box" :href="route('products.index')"
                    :current="request()->routeIs('products.*')" wire:navigate>
                    {{ __('Inventario') }}
                </flux:navlist.item>

                <flux:navlist.item icon="building-storefront" :href="route('branches.index')"
                    :current="request()->routeIs('branches.*')" wire:navigate>
                    {{ __('Sucursales') }}
                </flux:navlist.item>

                <flux:navlist.item icon="users" :href="route('suppliers.index')"
