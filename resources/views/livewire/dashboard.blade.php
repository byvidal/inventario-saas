...
<div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl">
    ...
    <div class="grid gap-6 md:grid-cols-4">
        ...
        <div class="relative overflow-hidden rounded-xl border border-neutral-200 bg-white p-6 dark:border-neutral-700 dark:bg-neutral-800">
            ...
            <div class="absolute right-4 top-4 text-blue-100 dark:text-blue-900/35">
                <svg class="h-12 w-12 opacity-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="relative overflow-hidden rounded-xl border border-neutral-200 bg-white p-6 dark:border-neutral-700 dark:bg-neutral-800">
            ...
            <div class="absolute right-4 top-4 text-emerald-100 dark:text-emerald-900/35">
                <svg class="h-12 w-12 opacity-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="relative overflow-hidden rounded-xl border border-neutral-200 bg-white p-6 dark:border-neutral-700 dark:bg-neutral-800">
            ...
            <div class="absolute right-4 top-4 text-purple-100 dark:text-purple-900/35">
                <svg class="h-12 w-12 opacity-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="relative overflow-hidden rounded-xl border border-neutral-200 bg-white p-6 dark:border-neutral-700 dark:bg-neutral-800">
            ...
            <div class="absolute right-4 top-4 text-orange-100 dark:text-orange-900/35">
                <svg class="h-12 w-12 opacity-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
